...
seu_diet$timepoint <- case_when(grepl("2446", seu_diet_merged$orig.ident) ~ "pre-transplant",
                                               grepl("25802", seu_diet_merged$orig.ident) ~ "3",
                                               grepl("2645", seu_diet_merged$orig.ident) ~ "6",
                                               grepl("1972", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("2220", seu_diet_merged$orig.ident) ~ "5",
                                               grepl("2621", seu_diet_merged$orig.ident) ~ "24",
                                               grepl("9185", seu_diet_merged$orig.ident) ~ "12",
                                               grepl("2599", seu_diet_merged$orig.ident) ~ "3",
                                               
                                               
                                               
                                               grepl("9596", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("25809", seu_diet_merged$orig.ident) ~ "3",
                                               grepl("2737", seu_diet_merged$orig.ident) ~ "9",
                                               grepl("2379", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("2434", seu_diet_merged$orig.ident) ~ "3",
                                               grepl("2518", seu_diet_merged$orig.ident) ~ "3",
                                               grepl("4618", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("6174", seu_diet_merged$orig.ident) ~ "3",
                                               grepl("9931", seu_diet_merged$orig.ident) ~ "12", 
                                               grepl("1953", seu_diet_merged$orig.ident) ~ "24",
                                               
                                               
                                               grepl("1677", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("1732", seu_diet_merged$orig.ident) ~ "1",
                                               grepl("1811", seu_diet_merged$orig.ident) ~ "3",
                                               grepl("1195", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("1285", seu_diet_merged$orig.ident) ~ "1.5",
                                               grepl("1347", seu_diet_merged$orig.ident) ~ "3", 
                                               grepl("5641", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("6244", seu_diet_merged$orig.ident) ~ "1.5",
                                               grepl("9355", seu_diet_merged$orig.ident) ~ "0",
                                               grepl("1013", seu_diet_merged$orig.ident) ~ "1.5",
