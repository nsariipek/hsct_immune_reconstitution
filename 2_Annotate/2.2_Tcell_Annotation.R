# Nurefsan Sariipek
# Since our project revolves around the T cells we wanted subset them and annotate them more.

library(tidyverse)
library(Seurat)
library("janitor")

# Set working directory (for Peter)
setwd("~/DropboxMGB/Projects/ImmuneEscapeTP53/TP53_ImmuneEscape/")

# Load the saved seurat object
seu_diet <- readRDS("../RDS files/seu_diet_merged.rds")
