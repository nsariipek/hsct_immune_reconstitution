...
# Rank the DGE results from 3.3_DGE_progenitors.R
de_results <- read_tsv("3.3_DGE_Recipient_vs_Donor_HSPCs.tsv")
...
data.table::fwrite(
  gseaRes,
  file = "3.4_GSEA_Recipient_vs_Donor_HSPCs.txt",
  sep = "\t",
  sep2 = c("", " ", "")
)
...
ggsave("3.4_GSEA_HSPCs_Hallmark.pdf", height = 4, width = 8)
