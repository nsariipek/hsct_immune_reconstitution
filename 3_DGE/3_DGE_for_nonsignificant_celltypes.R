...
# Add the donor/host information if needed for your selection
combined_df <- read_csv(paste0(my_wd, "TP53_ImmuneEscape/5_Souporcell/results/cohort1-2_souporcell.csv"))
...
ex$id =gsub("\\_", ".", ex$id)
# Select the the samples posst-HSCT 3-6 months
