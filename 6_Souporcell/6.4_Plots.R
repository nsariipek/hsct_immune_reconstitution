...
# Save as a pdf file
pdf("6.4.1_All_barplots.pdf", width = 16, height = 12)
p1
dev.off()
...
# Save as a pdf file
pdf("6.4.2_Barplot_per_patient.pdf", width = 8, height = 8)
p2
dev.off()
...
pdf("6.4.3_Souporcell_heatmap.pdf", width = 9, height = 5)
heatmap
dev.off()
...
pdf("6.4.4_Jitter_all.pdf", width = 8, height = 6)
jitter_all_plot
dev.off()
...
pdf("6.4.5_Jitter_all_merged.pdf", width = 4, height = 4)
merged_all_plot
dev.off()
...
pdf("6.4.6_Jitter_HSPCS.pdf", width = 8, height = 4)
prog_plots
dev.off()
...
pdf("6.4.7_Jitter_merged_HSPC.pdf", width = 4, height = 4)
merged_prog_plot
dev.off()
