...
###### Load Cohort3 #####
P09_0pre <- read.csv(paste0(my_wd, "TCR files/1677_MNC_filtered_contig_annotations.csv"))
P09_0preT <- read.csv(paste0(my_wd, "TCR files/1677_CD3_filtered_contig_annotations.csv"))

P09_1Rem <-  read.csv(paste0(my_wd, "TCR files/1732_MNC_filtered_contig_annotations.csv"))

P09_Rel <-  read.csv(paste0(my_wd, "TCR files/1811_MNC_filtered_contig_annotations.csv"))
P09_RelT <-  read.csv(paste0(my_wd, "TCR files/1811_CD3_filtered_contig_annotations.csv"))

P10_Rel <- read.csv(paste0(my_wd, "TCR files/1347_MNC_filtered_contig_annotations.csv"))
P10_RelT <- read.csv(paste0(my_wd, "TCR files/1347_CD3_filtered_contig_annotations.csv"))

P11_0pre <-  read.csv(paste0(my_wd, "TCR files/5641_MNC_filtered_contig_annotations.csv"))
P11_1Rem <- read.csv(paste0(my_wd, "TCR files/6244_MNC_filtered_contig_annotations.csv"))
P11_1RemT <- read.csv(paste0(my_wd, "TCR files/6244_CD3_filtered_contig_annotations.csv"))

P12_0pre <-  read.csv(paste0(my_wd, "TCR files/9355_MNC_filtered_contig_annotations.csv"))
